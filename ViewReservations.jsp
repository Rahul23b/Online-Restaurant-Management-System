...
<%!
    String userTable = "", reserveDate = "", reserveFrom ="", reserveTo = "";
 	String searchField = "", message = "", bookingName ="", contact="";
	Long bookingID = 0L, searchParameterID = 0L;
        ...
        <article class="expanded">
				...
				<%
				   try{
					     ...
					     if((request.getParameter("bookingID") != null) && !(request.getParameter("bookingID").equals(""))
							          && ((request.getParameter("contact2") != null) && !(request.getParameter("contact2").equals("")))) {
							 ...
							 if(cursor.count() == 0) {
								 System.out.println("Inside booking id part");
								 message = "Oops!! There are no reservations for the value you entered.. Please enter a correct value"; %>
							    <br>
						        <center><h3> <%= message%> </h3>	 
								<center><a href='ViewTable.jsp'> <input type='submit' value='Go Back'> </a></center>
							 <% } else {
								 ...
								 <%  int count = 0;
								   while(cursor.hasNext()) {
									 ...
									 <tr><td></td><td></td><td></td><td><h3 style="color:#000000;font-size:140%;"> Reservation: <%= count %> </h3></td></tr>
                                     ...
                                     %>	 
									 <tr><td></td><td></td><td></td><td width="35%"> Reservation Date (dd-MM-yyyy): </td>
									     <td><%=reserveDate%> </td>	                                     	
								 ...
								 <br><br>
								 <center><a href='ViewTable.jsp'> <input type='submit' value='Go Back'> </a>
								 <br><br>
								 <a href='DineIn.jsp'> <input type='submit' value='Go to Dine In Page'> </a></center>
								 
								 </center>					 
				                <% } 						 
					     } else if ((request.getParameter("bookingName") != null) && !(request.getParameter("bookingName").equals(""))
							          && ((request.getParameter("contact1") != null) && !(request.getParameter("contact1").equals("")))) {
							 bookingName = request.getParameter("bookingName");
							 contact = request.getParameter("contact1");
							 query.put("bookingName", bookingName);
							 query.put("contact", contact);
							 ...
							 if(cursor.count() == 0) {
								 System.out.println("Inside booking name part");
								 message = "Oops!! There are no reservations for the value you entered.. Please enter a correct value"; %>
							    <br>
						        <center><h3> <%= message%> </h3>	 
								<center><a href='ViewTable.jsp'> <input type='submit' value='Go Back'> </a></center>
							 ...
							 <center><h3> Please enter </h3><h4 style="font-size:130%;">booking name and contact number together</h4><h3> [or] </h3><h4 style="font-size:130%;">booking ID and contact number together</h4><h3> to view your reservations </h3></center>
							 <br>
							 <center><a href='ViewTable.jsp'> <input type='submit' value='Try Again'> </a>
							 <br><br>
							 <a href='DineIn.jsp'> <input type='submit' value='Go to Dine In Page'> </a></center>
						 <% } %>				 
